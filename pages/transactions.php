...
<!-- Navbar -->
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" action="transactions.php" method="get">
          ...
          <?php
                    if(!empty($_GET['date'])&&!empty($_GET['search'])){
                      ...
                      $result = $mysqli->query("SELECT 
                                      ...
                                      AND rental_status ='ongoing'") or die ($mysqli->error());
                      ...
                      JOIN users 
                      ON reservation.user_id = users.user_id 
                      WHERE rental_status ='ongoing'") or die ($mysqli->error());
                    }
